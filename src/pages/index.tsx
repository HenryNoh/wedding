		...
		<Container>
			<Wrapper>
				<Top>
					...
					<img className="sign" src="/sign.png" alt="/sign.png" />
				</Top>
				<img className="main1" src="/main1.jpg" alt="/main1.jpg" />
				<Desc>
					노태일 + 김유정
				...
				<Slider {...settings}>
					<div>
						<img src="/slider/slider1.jpg" alt="/main1.jpg" />
					</div>
					<div>
						<img src="/slider/slider2.jpg" alt="/main1.jpg" />
					</div>
					<div>
						<img src="/slider/slider3.jpg" alt="/main1.jpg" />
					</div>
					<div>
						<img src="/slider/slider4.jpg" alt="/main1.jpg" />
					</div>
					<div>
						<img src="/slider/slider5.jpg" alt="/main1.jpg" />
					</div>
				</Slider>
				<Call>
